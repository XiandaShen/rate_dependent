...
for ai=1:3
    ai
    clearvars -except phasen inputalpha inputc inputCG inputCK inputpr...
...
legend([cruves{1},cruves{2},cruves{3},cruves{4},cruves{5},cruves{6}],...
    'C1 (\phi_c = 10%)','C2 (\phi_c = 10%)','C3 (\phi_c = 30%)',...
    'C1 (\phi_c = 30%)','C2 (\phi_c = 50%)','C3 (\phi_c = 50%)','Location','southeast')
...
legend([cruves{1},cruves{2},cruves{3},cruves{4},cruves{5},cruves{6}],...
    'C1 (\phi_c = 10%)','C2 (\phi_c = 10%)','C3 (\phi_c = 30%)',...
    'C1 (\phi_c = 30%)','C2 (\phi_c = 50%)','C3 (\phi_c = 50%)','Location','southwest')
