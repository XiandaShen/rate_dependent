...
inputc=[0.001 0.003 0.005 0.007];
...
legend([cruves{1},cruves{2},cruves{3},cruves{4}],...
    'c = 1 \mum','c = 3 \mum','c = 5 \mum','c = 7 \mum','Location','southeast')
...
legend([cruves{1},cruves{2},cruves{3},cruves{4}],...
    'c = 1 \mum','c = 3 \mum','c = 5 \mum','c = 7 \mum','Location','southwest')
...
legend([cruves{1},cruves{2},cruves{3},cruves{4}],...
    'c = 1 \mum','c = 3 \mum','c = 5 \mum','c = 7 \mum','Location','northwest')
