...
'\phi_c = 10%','\phi_c = 30%','\phi_c = 50%','\phi_c = 70%','Location','southeast')

 figure
cruves{1}=plot(hstrain_c1(1,:),vstress_c1(1,:),'-k','LineWidth',1.5);
hold on
cruves{2}=plot(hstrain_c1(2,:),vstress_c1(1,:),'--k','LineWidth',1.5);
hold on
cruves{3}=plot(hstrain_c1(3,:),vstress_c1(1,:),'-.k','LineWidth',1.5);
hold on
...
legend([cruves{1},cruves{2},cruves{3},cruves{4}],...
'\phi_c = 10%','\phi_c = 30%','\phi_c = 50%','\phi_c = 70%','Location','southwest')
...
legend([cruves{1},cruves{2},cruves{3},cruves{4}],...
'\phi_c = 10%','\phi_c = 30%','\phi_c = 50%','\phi_c = 70%','Location','northwest')
