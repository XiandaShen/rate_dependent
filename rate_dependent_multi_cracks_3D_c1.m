...
load('slide1.mat','slideoutput');
load('boundary1.mat','ttboundary');
...
cruves{2}=plot(vstrain(1:cstep_ll(2),2)+bc{2}(1,2)-bc{1}(1,2)-vstrain(1,2),vstress(1:cstep_ll(2),2)-vstress(1,2),'-k','LineWidth',1.5);
hold on
...
ylabel('Differential stress (MPa)','fontsize',18);
xlabel('\epsilon_a','fontsize',18);
legend([cruves{2},cruves{4},cruves{5},cruves{6}],...
    'C1, C2, C3 (Simulation)','C1 (Experiment)','C2 (Experiment)','C3 (Experiment)','Location','southeast')
...
ylabel('Differential stress (MPa)','fontsize',16);
xlabel('\epsilon_r','fontsize',16);
legend([cruves{1},cruves{4},cruves{5},cruves{6}],...
    'C1, C2, C3 (Simulation)','C1 (Experiment)','C2 (Experiment)','C3 (Experiment)','Location','northeast')
