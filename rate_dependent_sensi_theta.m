...
inputtheta=[pi/18 pi/6 pi/3];


cstep(1)=100;
cstep(2)=1000;

vstrain_c1=zeros(3,cstep(1)*2);
vstrain_c2=zeros(3,cstep(2)*2);

hstrain_c1=zeros(3,cstep(1)*2);
hstrain_c2=zeros(3,cstep(2)*2);

vstress_c1=zeros(3,cstep(1)*2);
vstress_c2=zeros(3,cstep(2)*2);
...
eta=zeros(1,phasen);
reta=zeros(tstep,2);
re_sigma_n1=zeros(tstep,2);
re_sigma_n2=zeros(tstep,2);
...
vstrain_c2(ai,:)=vstrain(1:cstep_ll(2),2)-vstrain(1,1);
vstress_c1(ai,:)=vstress(1:cstep_ll(1),1)-vstress(1,1);
vstress_c2(ai,:)=vstress(1:cstep_ll(2),2)-vstress(1,1);
hstrain_c1(ai,:)=hstrain(1:cstep_ll(1),1)-hstrain(1,1);
hstrain_c2(ai,:)=hstrain(1:cstep_ll(2),2)-hstrain(1,1);
end 
...
hold on
cruves{2}=plot(vstrain_c2(1,:),vstress_c2(1,:),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(vstrain_c1(2,:),vstress_c1(2,:),'--k','LineWidth',1.5);
hold on
cruves{4}=plot(vstrain_c2(2,:),vstress_c2(2,:),'--r','LineWidth',1.5);
hold on
cruves{5}=plot(vstrain_c1(3,:),vstress_c1(3,:),':k','LineWidth',1.5);
hold on
cruves{6}=plot(vstrain_c2(3,:),vstress_c2(3,:),':r','LineWidth',1.5);
hold on
...
legend([cruves{1},cruves{2},cruves{3},cruves{4},cruves{5},cruves{6}],...
    'C1 (\theta = 10^o)','C2 (\theta = 10^o)','C3 (\theta = 30^o)',...
    'C1 (\theta = 30^o)','C2 (\theta = 60^o)','C3 (\theta = 60^o)','Location','southeast')


 figure
cruves{1}=plot(hstrain_c1(1,:),vstress_c1(1,:),'-k','LineWidth',1.5);
hold on
cruves{2}=plot(hstrain_c2(1,:),vstress_c2(1,:),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(hstrain_c1(2,:),vstress_c1(1,:),'--k','LineWidth',1.5);
hold on
cruves{4}=plot(hstrain_c2(2,:),vstress_c2(1,:),'--r','LineWidth',1.5);
hold on
cruves{5}=plot(hstrain_c1(3,:),vstress_c1(1,:),':k','LineWidth',1.5);
hold on
cruves{6}=plot(hstrain_c2(3,:),vstress_c2(1,:),':r','LineWidth',1.5);
hold on
...
legend([cruves{1},cruves{2},cruves{3},cruves{4},cruves{5},cruves{6}],...
    'C1 (\theta = 10^o)','C2 (\theta = 10^o)','C3 (\theta = 30^o)',...
    'C1 (\theta = 30^o)','C2 (\theta = 60^o)','C3 (\theta = 60^o)','Location','southwest')
