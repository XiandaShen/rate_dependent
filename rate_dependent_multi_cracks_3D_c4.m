...
for ai=1:1
    ai
    clearvars -except phasen slideoutput inputalpha inputDS inputCG inputCK ttboundary ai sampling cracknumber ntheta psampling
...
for i=1:psampling
    for j=1:sampling
        for k=1:ntheta
            theta((i-1)*sampling*ntheta+(j-1)*ntheta+k)=thetao(k);
...
pr=zeros(phasen,1);
for i=1:phasen-1
   pr(i)=1/sampling/ntheta/psampling*beta1*((size(slideoutput,1))/bi)^(beta2);
end 
temp1=sum(pr(:));
pr(phasen)=1-temp1;
...
if tt==cstep(1)*2+cstep(2)*2+cstep(3)
...
cruves{1}=plot(vstrain(1:cstep_ll(1),1)-vstrain(1,1),re_sigma_n1(1:cstep_ll(1),1),'-k','LineWidth',1.5);
hold on
cruves{2}=plot(vstrain(1:cstep_ll(2),2)-vstrain(1,1),re_sigma_n1(1:cstep_ll(2),2),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(vstrain(1:cstep_ll(3),3)-vstrain(1,1),re_sigma_n1(1:cstep_ll(3),3),'-b','LineWidth',1.5);
hold on
cruves{4}=plot(vstrain(1:cstep_ll(1),1)-vstrain(1,1),re_sigma_n2(1:cstep_ll(1),1),'--k','LineWidth',1.5);
hold on
cruves{5}=plot(vstrain(1:cstep_ll(2),2)-vstrain(1,1),re_sigma_n2(1:cstep_ll(2),2),'--r','LineWidth',1.5);
hold on
cruves{6}=plot(vstrain(1:cstep_ll(3),3)-vstrain(1,1),re_sigma_n2(1:cstep_ll(3),3),'--b','LineWidth',1.5);
hold on

set(gcf, 'position', [200 200 500 400]);
set(gca,'FontSize',18)
xlabel('\Delta\epsilon_a','fontsize',18)
ylabel('\sigma_n (MPa)','fontsize',18)
legend([cruves{1},cruves{2},cruves{3},cruves{4},cruves{5},cruves{6}],...
    'C1 (\sigma_n^1)','C2 (\sigma_n^1)','C3 (\sigma_n^1)','C1 (\sigma_n^2)'...
    ,'C2 (\sigma_n^2)','C3 (\sigma_n^2)','Location','southeast')
axis([0 0.00054 0 6])
savefig(['rate_d_sn_CK',num2str(ai),'.fig'])
% 
% 
 figure
cruves{1}=plot(vstrain(1:cstep_ll(1),1)-vstrain(1,1),reta(1:cstep_ll(1),1),'-k','LineWidth',1.5);
hold on
cruves{2}=plot(vstrain(1:cstep_ll(2),2)-vstrain(1,1),reta(1:cstep_ll(2),2),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(vstrain(1:cstep_ll(3),3)-vstrain(1,1),reta(1:cstep_ll(3),3),'-b','LineWidth',1.5);
hold on
set(gca,'FontSize',16);
set(gcf, 'position', [200 200 500 400]);
ylabel('\gamma_c','fontsize',18);
xlabel('\Delta\epsilon_a','fontsize',18);
legend([cruves{1},cruves{2},cruves{3}],...
    'C1','C2','C3','Location','southeast')
axis([0 0.0004 0 0.00025])
savefig(['rate_d_se_CK',num2str(ai),'.fig'])


 figure
cruves{1}=plot(vstrain(1:cstep_ll(1),1)-vstrain(1,1),vstress(1:cstep_ll(1),1)-vstress(1,1),'-k','LineWidth',1.5);
hold on
cruves{2}=plot(vstrain(1:cstep_ll(2),2)+bc{2}(1,2)-bc{1}(1,2)-vstrain(1,2),vstress(1:cstep_ll(2),2)-vstress(1,2),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(vstrain(1:cstep_ll(3),3)+bc{3}(1,2)-bc{1}(1,2)-vstrain(1,3),vstress(1:cstep_ll(3),3)-vstress(1,3),'-b','LineWidth',1.5);
hold on
cruves{4}=plot(bc{1}(:,2)-bc{1}(1,2),bc{1}(:,5),'--k','LineWidth',1.5);
cruves{5}=plot(bc{2}(:,2)-bc{1}(1,2),bc{2}(:,5),'--r','LineWidth',1.5);
cruves{6}=plot(bc{3}(:,2)-bc{1}(1,2),bc{3}(:,5),'--b','LineWidth',1.5);
...
xlabel('\Delta\epsilon_a','fontsize',18);
legend([cruves{1},cruves{2},cruves{3},cruves{4},cruves{5},cruves{6}],...
    'C1 (Simulation)','C2 (Simulation)','C3 (Simulation)','C1 (Experiment)','C2 (Experiment)','C3 (Experiment)','Location','southeast')

savefig(['rate_d_ssv_CK',num2str(ai),'.fig'])

 figure
cruves{1}=plot(hstrain(1:cstep_ll(1),1)-hstrain(1,1),vstress(1:cstep_ll(1),1)-vstress(1,1),'-k','LineWidth',1.5);
hold on
cruves{2}=plot(hstrain(1:cstep_ll(2),2)+bc{2}(1,3)-bc{1}(1,3)-hstrain(1,2),vstress(1:cstep_ll(2),2)-vstress(1,2),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(hstrain(1:cstep_ll(3),3)+bc{3}(1,3)-bc{1}(1,3)-hstrain(1,3),vstress(1:cstep_ll(3),3)-vstress(1,3),'-b','LineWidth',1.5);
hold on
cruves{4}=plot(bc{1}(:,3)-bc{1}(1,3),bc{1}(:,5),'--k','LineWidth',1.5);
cruves{5}=plot(bc{2}(:,3)-bc{1}(1,3),bc{2}(:,5),'--r','LineWidth',1.5);
cruves{6}=plot(bc{3}(:,3)-bc{1}(1,3),bc{3}(:,5),'--b','LineWidth',1.5);

set(gca,'FontSize',16);
set(gcf, 'position', [200 200 500 400]);
ylabel('Differential stress (MPa)','fontsize',16);
xlabel('\Delta\epsilon_a','fontsize',16);
legend([cruves{1},cruves{2},cruves{3},cruves{4},cruves{5},cruves{6}],...
    'C1 (Simulation)','C2 (Simulation)','C3 (Simulation)','C1 (Experiment)','C2 (Experiment)','C3 (Experiment)','Location','southeast')
...
% hold on
% cruves{2}=plot(vstrain(1:cstep_ll(2),2)-vstrain(1,1),vstress(1:cstep_ll(2),2)-vstress(1,2),'-r','LineWidth',2);
% hold on
% cruves{3}=plot(vstrain(1:cstep_ll(3),3)-vstrain(1,1),vstress(1:cstep_ll(3),3)-vstress(1,3),'-b','LineWidth',2);
% hold on
...
% hold on
% cruves{2}=plot(hstrain(1:cstep_ll(2),2)-hstrain(1,1),vstress(1:cstep_ll(2),2)-vstress(1,2),'-r','LineWidth',2);
% hold on
% cruves{3}=plot(hstrain(1:cstep_ll(3),3)-hstrain(1,1),vstress(1:cstep_ll(3),3)-vstress(1,3),'-b','LineWidth',2);
% hold on
...
cruves{2}=plot(hstrain(1:cstep_ll(2),2)+bc{2}(1,3)-bc{1}(1,3)-hstrain(1,2),vstress(1:cstep_ll(2),2)-vstress(1,2),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(hstrain(1:cstep_ll(3),3)+bc{3}(1,3)-bc{1}(1,3)-hstrain(1,3)+0.00002,vstress(1:cstep_ll(3),3)-vstress(1,3),'-b','LineWidth',1.5);
hold on
cruves{4}=plot(bc{1}(:,3)-bc{1}(1,3),bc{1}(:,5),'--k','LineWidth',1.5);
cruves{5}=plot(bc{2}(:,3)-bc{1}(1,3),bc{2}(:,5),'--r','LineWidth',1.5);
cruves{6}=plot(bc{3}(:,3)-bc{1}(1,3),bc{3}(:,5),'--b','LineWidth',1.5);
...
set(gcf, 'position', [200 200 500 400]);
ylabel('Differential stress (MPa)','fontsize',16);
xlabel('\Delta\epsilon_l','fontsize',16);
legend([cruves{1},cruves{2},cruves{3},cruves{4},cruves{5},cruves{6}],...
...
ylabel('\sigma_n (MPa)','fontsize',18)
legend([cruves{1},cruves{2},cruves{3},cruves{4},cruves{5},cruves{6}],...
    'C1 (n1)','C2 (n1)','C3 (n1)','C1 (n2)'...
    ,'C2 (n2)','C3 (n2)','Location','southeast')
axis([0 0.0005 0 6])
savefig(['rate_d_sn_CK',num2str(ai),'.fig'])
% 
% 
 figure
cruves{1}=plot(vstrain(1:cstep_ll(1),1)-vstrain(1,1)+bc{1}(1,3),reta(1:cstep_ll(1),1),'-k','LineWidth',1.5);
hold on
cruves{2}=plot(vstrain(1:cstep_ll(2),2)-vstrain(1,1)+bc{1}(1,3),reta(1:cstep_ll(2),2),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(vstrain(1:cstep_ll(3),3)-vstrain(1,1)+bc{1}(1,3),reta(1:cstep_ll(3),3),'-b','LineWidth',1.5);
hold on
set(gca,'FontSize',16);
set(gcf, 'position', [200 200 500 400]);
...
savefig(['rate_d_se_CK',num2str(ai),'.fig'])
 ...
 figure
cruves{1}=plot(vstrain(1:cstep_ll(1),1)+bc{1}(1,2)-vstrain(1,1),vstress(1:cstep_ll(1),1)-vstress(1,1),'-k','LineWidth',1.5);
hold on
cruves{2}=plot(vstrain(1:cstep_ll(2),2)+bc{2}(1,2)-vstrain(1,2),vstress(1:cstep_ll(2),2)-vstress(1,2),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(vstrain(1:cstep_ll(3),3)+bc{3}(1,2)-vstrain(1,3),vstress(1:cstep_ll(3),3)-vstress(1,3),'-b','LineWidth',1.5);
hold on
cruves{4}=plot(bc{1}(:,2),bc{1}(:,5),'--k','LineWidth',1.5);
cruves{5}=plot(bc{2}(:,2),bc{2}(:,5),'--r','LineWidth',1.5);
cruves{6}=plot(bc{3}(:,2),bc{3}(:,5),'--b','LineWidth',1.5);
...
%     'cycle 1-s','cycle 2-s','cycle 3-s','cycle 1-e','cycle 2-e','cycle 3-e','Location','southeast')
 ...
 figure
cruves{1}=plot(hstrain(1:cstep_ll(1),1)+bc{1}(1,3)-hstrain(1,1),vstress(1:cstep_ll(1),1)-vstress(1,1),'-k','LineWidth',1.5);
hold on
cruves{2}=plot(hstrain(1:cstep_ll(2),2)+bc{2}(1,3)-hstrain(1,2),vstress(1:cstep_ll(2),2)-vstress(1,2),'-r','LineWidth',1.5);
hold on
cruves{3}=plot(hstrain(1:cstep_ll(3),3)+bc{3}(1,3)-hstrain(1,3)+0.00002,vstress(1:cstep_ll(3),3)-vstress(1,3),'-b','LineWidth',1.5);
hold on
cruves{4}=plot(bc{1}(:,3),bc{1}(:,5),'--k','LineWidth',1.5);
cruves{5}=plot(bc{2}(:,3),bc{2}(:,5),'--r','LineWidth',1.5);
cruves{6}=plot(bc{3}(:,3),bc{3}(:,5),'--b','LineWidth',1.5);
